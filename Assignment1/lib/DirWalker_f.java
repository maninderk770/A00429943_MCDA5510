...
public class DirWalker_f {
	...
	public synchronized void csvParser(File f, CSVPrinter csv) {
		...
		try {
			...
			in = new FileReader(f);
			String[] path1 = f.getAbsolutePath().toString().split(File.separator);
	...
	public static void main(String[] args) throws IOException {
		...
		BufferedWriter writer = Files.newBufferedWriter(Paths.get("/home/student_2018_fall/b_shree/A00431152_MCDA5510/Assignment1/output/Assignment1.csv"));
		...
		FileHandler handler = new FileHandler("/home/student_2018_fall/b_shree/A00431152_MCDA5510/Assignment1/output/capturedlogs.log", false);


		logger.addHandler(handler);

		fw.walk("/home/student_2018_fall/b_shree/A00431152_MCDA5510/Assignment1/Sample_Data/Sample_Data", csvPrinter);
		csvPrinter.flush();
		csvPrinter.close();
